...
<div data-role="page" id="order-page" data-url="order-page">
	...
	<div data-role="content">
		<div class="pos_top">
			<div class="top01">
				<div class="btn_fl">
					<a href="#" class="btn_01 class-event-memo-register">메모</a><a href="#" class="btn_01 class-event-reservation" data-rel="popup" data-position-to="window" data-transition="pop">예약</a>
