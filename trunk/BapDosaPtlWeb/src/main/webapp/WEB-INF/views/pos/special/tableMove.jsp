...
<script type="text/javascript" src="../../js/pos/tableMove.js"></script>
</head>
<body>
<div data-role="page" id="tableMove-page" data-url="demo-page">
...
<!-- 				<li>
		...
		<div class="tb_move">
			<div class="mv_box">
				<div class="mv_data">
					<div class="mv_befor">
						<p>이동 전</p>
						<p class="wbox" id="id_area_move_before"></p>
					</div>
					<div class="mv_after">
						<p>이동 후</p>
						<p class="wbox" id="id_area_move_after"></p>
					</div>
				</div>
				<div class="mv_memo">
					<p>메모</p>
		...
		<div class="btn_c tline">
			<a href="#" class="btn_blue class-event-move-save">저장</a><a href="#" class="btn_white" data-rel="back">돌아가기</a>
		</div>
	</div>
	<div data-role="footer" data-position="fixed">
		<div class="help">
			<a href="delivery_count.html" class="pnprev" data-ajax="false"><span>&lt;</span></a><!-- 개발에선 지워주세요 -->
			<p><span>먼저 이동할 좌석을 선택하세요.</span></p>
			<a href="table_share.html" class="pnnext" data-ajax="false"><span>&gt;</span></a><!-- 개발에선 지워주세요 -->
		</div>
	</div>
</div>
</body>
