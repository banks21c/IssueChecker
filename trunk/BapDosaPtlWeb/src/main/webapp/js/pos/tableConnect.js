...
//			var before = $("#tableConnect-page #id_area_move_before").text() || "";
//			var after = $("#tableConnect-page #id_area_move_after").text() || "";
//			
//			if(before){
//				$("#tableConnect-page #id_area_move_after").text(tableName).attr({"tableId": tableId, "orderId": orderId});
//			} else {
//				$("#tableConnect-page #id_area_move_before").text(tableName).attr({"tableId": tableId, "orderId": orderId});
//			}
